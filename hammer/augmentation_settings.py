...
from hammer.augmentation_strategies import (
...
class AugmentationSettings(Hashable):
    ...
    def augment(
        ...
        flattened_augmented_smiles: List[List[str]] = [
