...
class Dataset:
    ...
    def __init__(
        ...
        self._features_kwargs = {
            ...
            "include_autocorr_fingerprint": include_autocorr_fingerprint,
            "include_extended_connectivity_fingerprint": include_extended_connectivity_fingerprint,
            "include_extended_reduced_graph_fingerprint": include_extended_reduced_graph_fingerprint,
            "include_estate_fingerprint": include_estate_fingerprint,
            "include_functional_groups_fingerprint": include_functional_groups_fingerprint,
            "include_ghose_crippen_fingerprint": include_ghose_crippen_fingerprint,
            "include_klekota_roth_fingerprint": include_klekota_roth_fingerprint,
            "include_laggner_fingerprint": include_laggner_fingerprint,
            "include_layered_fingerprint": include_layered_fingerprint,
            "include_lingo_fingerprint": include_lingo_fingerprint,
            "include_map_fingerprint": include_map_fingerprint,
            "include_mhfp_fingerprint": include_mhfp_fingerprint,
            "include_mqns_fingerprint": include_mqns_fingerprint,
            "include_pattern_fingerprint": include_pattern_fingerprint,
            "include_pubchem_fingerprint": include_pubchem_fingerprint,
            "include_smiles_extended_connectivity_fingerprint": include_smiles_extended_connectivity_fingerprint,
            "include_vsa_fingerprint": include_vsa_fingerprint,
